...
activity <- read_csv("../input/Activity.csv")
head(activity)
nrow(activity)
#na.omit(activity)
#nrow(activity)
...
asset <- read_csv("../input/AUM.csv")
head(asset)
nrow(asset)



Transaction  <- read_csv("../input/Transaction.csv")
head(Transaction)
nrow(Transaction)

Experience <- read_csv("../input/Experience.csv")
head(Experience)
nrow(Experience)
...
#head(test_data)
#yr1_return <- train_data$1 Yr Return
#Excess <- train_data$1 Yr Excess Return vs Primary Ix
